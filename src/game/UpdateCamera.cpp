...
void Game::UpdateCamera(ES::Engine::Core &core)
{
    ...
    for (auto entity : view)
    {
        ...
        middlePos = box.GetMiddlePoint(core);
        gVelocity = box.GetVelocity(core);
    }
    ...
    auto view2 = core.GetRegistry().view<Raylib::Camera3D>();
